...
- **[User guide](user-guide.md)** — how to draw a font, set widths and guides,
  manage codepoints, and get files out. Start here.
- **[File formats](file-formats.md)** — the exact bytes and JSON the editor reads
